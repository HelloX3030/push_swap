...
PUSH_SWAP_SRC_FILES := ft_10sort.c ft_2sort.c ft_3sort.c ft_bubble_sort.c ft_debug_sort.c ft_get_content.c ft_get_diff.c ft_get_index_distance.c ft_get_max_stack_index.c ft_get_min_stack_index.c ft_get_stack_index.c ft_go_to_index.c ft_go_to_indexes.c ft_improved_sort_back.c ft_improved_sort_in_b.c ft_k_sort.c ft_move_to_start.c ft_proxy_sort.c ft_proxy_sort_prototype.c ft_push_back.c ft_sort_back.c ft_sort.c ft_sort_in_b.c ft_stalin_sort.c push_swap_main.c
