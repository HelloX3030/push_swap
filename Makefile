...
PUSH_SWAP_SRC_FILES := ft_bubble_sort.c ft_custom_sort.c ft_debug_sort.c ft_get_diff.c ft_get_min_index.c ft_get_total_diff.c ft_sort.c ft_sort_in_b.c ft_stalin_sort.c push_swap_main.c
