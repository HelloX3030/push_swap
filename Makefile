...
vpath %.c $(SRC_DIR)
BASE_SRC_FILES := ft_free_content.c ft_free_push_swap.c ft_get_prev.c ft_init_lst_indexes.c ft_init_push_swap.c ft_is_sorted.c ft_print_error.c ft_print_push_swap.c ft_print_stack.c ft_push.c ft_reverse_rotate.c ft_rotate.c swap.c
